...
2.  Identify applications whose names contain the target prefix, `FoldingAtRunOnFlux`.
...
*   **Targeting:** The automation logic specifically targets applications where the container name includes the prefix `FoldingAtRunOnFlux`.
*   **API Interaction:** The application communicates with the Flux API (hardcoded to `http://89.223.66.97:16127`) for listing and removing applications.

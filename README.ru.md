...
>
> *Примечание для пользователей ArcaneOS:* Благодаря новому режиму **Monitor Mode**, вы можете полностью скрыть веб-интерфейс ноды после авторизации, сфокусировавшись на мониторинге событий через полноэкранный лог. Основной функционал - определение входа в систему и автоматическая остановка приложений - работает корректно.
...
![Скриншот Flux Node Manager v1.0.0](assets/screenshot.png)
...
Вы можете выбрать:
*   **Portable (.zip):** Установка не требуется. Просто распакуйте и запустите `FluxNodeManager_Portable_1.0.0.exe`.

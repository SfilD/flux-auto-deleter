...
2.  **Portable-версия (EXE):**
    *   Одиночный файл `FluxAutoDeleter_Portable_X.X.X.exe`. Удобен для обновления: просто замените старый `.exe` файл новым в папке с программой.
...
3.  Выберите удобный способ (рекомендуются **Wallets** или **Manual**):
    ...
    *   *Примечание: Другие способы (Google, Apple, MetaMask) могут работать, но специально не тестировались с этим приложением.*

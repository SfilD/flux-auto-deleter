...
Приложение хранит данные сессий (авторизацию на нодах) в отдельной системной папке. Если вы хотите полностью удалить все следы использования или сбросить все авторизации, удалите следующую папку:
...
1.  Откройте вкладку проблемной ноды.
2.  Нажмите кнопку **Reset** (Сброс) на верхней панели инструментов.
3.  Это действие полностью очистит куки и кэш *только для этой ноды* и перезагрузит страницу.
4.  Выполните вход (Login) заново. Автоматизация должна восстановиться.